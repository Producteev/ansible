...
NEXUS_BASE=http://10.1.1.250:8081/nexus
REST_PATH=/service/local
ART_REDIR=/artifact/maven/redirect
VER_NUMBER="$(cat dev-ver.txt)"
...
wget ${REDIRECT_URL} -O $VERSION.tar.gz

rm -rf /var/www/dev-producteev && tar -zxvf $VERSION.tar.gz -C /var/www
#
chown -R apache:apache /var/www/dev-producteev
